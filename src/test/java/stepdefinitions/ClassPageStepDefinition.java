...
public class ClassPageStepDefinition {
	...
	Baseclass testbase;
	ClassPage classPage;
	private Class_add_obj  adddata =new Class_add_obj();
	...
	public void admin_should_see_the_manage_class_page() {
		...
		Logger.info("Admin enter in to the MangeClassPage");
	}
...
//Class detail Popup Window verification
	...
	public void admin_should_see_new_class_details_is_added_in_the_data_table(DataTable dataTable) {
	 ...
	 @When("Admin enters all mandatory field values with valid data {string} and clicks save button {string}")
	    public void admin_enters_all_mandatory_field_values_with_valid_data_and_clicks_save_button(String keyOptions, String sheetName) {
	     Xlutilsdata.ClassXLdata(keyOptions, sheetName);
